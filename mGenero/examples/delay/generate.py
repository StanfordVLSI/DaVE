...
generic_module_name = 'delay'
dut = 'delay1'

cfg_f = "circuit.cfg" # user configuration of interface template
#ifc_f = os.path.join('/home/bclim/proj/dave-eda/mGenero/template/','{0}/{0}.ifc.yaml'.format(generic_module_name)) # interface template
#mdl_template = os.path.join('/home/bclim/proj/dave-eda/mGenero/template/','{0}/{1}'.format(generic_module_name,'%s.template.sv' % generic_module_name)) # model template
#test_template = os.path.join('/home/bclim/proj/dave-eda/mGenero/template/','{0}/{1}'.format(generic_module_name,'%s.test.template.cfg' % generic_module_name)) # test template
