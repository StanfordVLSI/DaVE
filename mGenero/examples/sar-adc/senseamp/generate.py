...
generic_module_name = 'regenerative_latch'
dut = 'senseamp'
...
mdl_dst_file = '%s.v' % dut 
mdl_i_dst_file = '%s.intermediate.v' % dut if enable_calibration else mdl_dst_file  # intermediate verilog model (before back-annotation)
...
m.generate_model(mdl_template, mdl_i_dst_file, calibration=enable_calibration) 
