...
-----------------------------------------------------------------
 ...
 Here are some restrictions:
  - analog inputs are either pwl or real waveform
  - All outputs are real (parameters to other block)
  - N digital inputs need 2**N look-up tables

-----------------------------------------------------------------
 Copyright (c) @(year) by @(licensor). All rights reserved.

 The information and source code contained herein is the property
 of @(licensor), and may not be disclosed or reproduced
 in whole or in part without explicit written authorization from
 @(licensor). For more details, email to @(contact)
-----------------------------------------------------------------
****************************************************************/
